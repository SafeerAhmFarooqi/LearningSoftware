...
use App\Services\DateRangePickerService;
use Livewire\Component;

class DateRangePicker2 extends Component
{
    public $serializedDateRangePickerObject = '';
    ...
    public function setInputAttributes(){
        ...
        $this->setInputAttribute('id','__date_range_picker',true);
    ...
    public function setDateRangePicker(){
        $this->serializedDateRangePickerObject = serialize(new DateRangePickerService);
    }

    public function dateRangePicker($shouldUnserialize = true){
        if ($shouldUnserialize) {
            $this->dateRangePicker = unserialize($this->serializedDateRangePickerObject);
        }
        return $this->dateRangePicker;
    }

    public function syncDateRangePicker(){
        $dateRangePicker = $this->dateRangePicker();
        $this->selectedDateString = $dateRangePicker->getRawDateString(); 
    }

    public function render()
    {
        $this->syncDateRangePicker();
        return view('livewire.date-range-picker2');
        return <<<'blade'
<div>
